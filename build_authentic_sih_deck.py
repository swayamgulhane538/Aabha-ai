...
def build_authentic_sih_deck():
    prs = Presentation()
    prs.slide_width = Inches(13.333)
    prs.slide_height = Inches(7.5)
    blank_layout = prs.slide_layouts[6]

    # Exact SIH Template Colors
    ...
    def apply_template_chrome(slide, slide_num, center_title=None, is_title_page=False):
        ...
        # 2. Bottom Solid Blue Footer Bar
        ...
        # 3. Top SIH Official Logo (Top-Right)
    ...
    apply_template_chrome(s1, 1, center_title=None, is_title_page=True)
    ...
    # Left Bullet Details (Strictly matching template items)
    ...
    apply_template_chrome(s2, 2, center_title="AABHA AI (Cognitive Healthcare Companion)")
    ...
    apply_template_chrome(s3, 3, center_title="TECHNICAL APPROACH")
    ...
    apply_template_chrome(s4, 4, center_title="FEASIBILITY AND VIABILITY")
    ...
    # Point 2: Potential challenges and risks
    # Point 3: Strategies for overcoming these challenges
    ...
    matrix_rows = [
        ("Potential Challenge: Poor Internet in Rural India", "Strategy: 100% Offline-First Architecture with Service Workers & IndexedDB. Alarms & games function without internet.", GREEN_ACCENT),
        ("Potential Challenge: Multi-Lingual Dialects & Noise", "Strategy: Resilient NLP with Multi-Turn Clarification Memory and fuzzy entity parsing in Hindi, Marathi, and English.", HEADING_BLUE),
        ("Potential Challenge: Elderly Fear of Complex Tech", "Strategy: Ultra-simple 1-tap touch cards, high-contrast visual cues, and automated spoken voice reading with zero learning curve.", PURPLE_BORDER)
    ]
    ...
    apply_template_chrome(s5, 5, center_title="IMPACT AND BENEFITS")
    ...
    # Point 2: Benefits of solution (social, economic, environmental, etc.)
    ...
    benefits_cards = [
        ("🌍 Social Benefits", "Promotes inclusive digital health for India's 6.3 Cr seniors and 1.8 Cr deaf/mute community under Ayushman Bharat (ABDM).", HEADING_BLUE),
    ...
    apply_template_chrome(s6, 6, center_title="RESEARCH AND REFERENCES")
    ...
    print(f"Authentic SIH Template PPTX successfully created at: {output_pptx}")

if __name__ == "__main__":
    build_authentic_sih_deck()
