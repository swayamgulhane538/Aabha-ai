...
def build_winning_sih_deck():
    ...
    def apply_sih_chrome(slide, slide_num, center_title=None, is_title_page=False):
        ...
        # 2. Bottom Official Blue Footer Bar
    ...
    # ══════════════════════════════════════════════════════════════════════════
    # SLIDE 1: TITLE PAGE (HIGH-IMPACT EXECUTIVE OVERVIEW)
    # ══════════════════════════════════════════════════════════════════════════
    s1 = prs.slides.add_slide(blank_layout)
    apply_sih_chrome(s1, 1, center_title=None, is_title_page=True)
    ...
    title_points = [
        ...
        ("•  PS Category –", "Software (Web, Mobile & Offline Edge AI)"),
    ...
    apply_sih_chrome(s2, 2, center_title="AABHA AI (Assistive Healthcare Companion)")
    ...
    p2.text = "   - Core Modules: 1) Gemini 3.7/2.5 AI Voice Action Agent (executes real CRUD commands in Hindi/Marathi/English); 2) Personalized Spoken Voice Alarms with temple bells; 3) SignBridge (ISL 21-point hand tracking teleconsultation); 4) Reminiscence Memory Passport & Games."
    ...
    apply_sih_chrome(s3, 3, center_title="TECHNICAL APPROACH")
    ...
    apply_sih_chrome(s4, 4, center_title="FEASIBILITY AND VIABILITY")
    ...
    apply_sih_chrome(s5, 5, center_title="IMPACT AND BENEFITS")
    ...
    # ══════════════════════════════════════════════════════════════════════════
    # SLIDE 6: RESEARCH AND REFERENCES (EXECUTIVE PROOF)
    # ══════════════════════════════════════════════════════════════════════════
    s6 = prs.slides.add_slide(blank_layout)
    apply_sih_chrome(s6, 6, center_title="RESEARCH AND REFERENCES")
    ...
    print(f"Judge-Winning Authentic SIH Deck successfully created at: {output_pptx}")

if __name__ == "__main__":
    build_winning_sih_deck()
